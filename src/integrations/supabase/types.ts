...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      _backup_mv_caixa_completa_26_05: {
        Row: {
          advisor: string | null
          anomes: number | null
          banker: string | null
      ...
      _backup_mv_caixa_completa_27_05_v2: {
        Row: {
          advisor: string | null
          anomes: number | null
          banker: string | null
      ...
      _backup_raw_comissoes_historico_staging_25_05: {
        Row: {
          data: Json | null
          id: number | null
          ingested_at: string | null
    ...
    Functions: {
      ...
      pode_gerenciar_configuracoes_hub: {
