...
const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "menu_dashboards_lavoro", label: "Dashboards Lavoro", desc: "Controle mestre de dashboards da Lavoro Seguros" },
      { key: "menu_dashboards_lavoro_receita", label: "↳ Receita Lavoro", desc: "Sub-item — Dashboard de Receita (Competência x Caixa)" },
      { key: "menu_relatorios_gerencial_apolices", label: "↳ Gerencial de Apólices", desc: "Sub-item de Relatórios — visão operacional por apólice" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "menu_importar_lavoro_gerencial", label: "↳ Importar Base Gerencial (Lavoro)", desc: "Sub-item de Importar Bases" },
      { key: "menu_importar_lavoro_caixa", label: "↳ Importar Caixa Bradesco (Lavoro)", desc: "Sub-item de Importar Bases" },
