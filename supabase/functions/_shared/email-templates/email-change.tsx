...
export const EmailChangeEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme seu novo e-mail — Hub Tailor Partners</Preview>
    <Body style={main}>
      ...
      <Container style={container}>
        <Heading style={h1}>Confirme a alteração de e-mail ✉️</Heading>
        <Text style={text}>
          Você solicitou a alteração do seu e-mail no <strong>Hub Tailor Partners</strong> de{' '}
