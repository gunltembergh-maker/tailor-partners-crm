...
-- ============================================================================
-- HOTFIX: Adicionar #variable_conflict use_column nas 6 RPCs Receita Caixa
-- que usam RETURNS TABLE para resolver erro SQL 42702 (ambiguous column)
-- ============================================================================

-- 1) rpc_receita_caixa_por_subcategoria (a que está quebrando)
...
-- 3) rpc_receita_caixa_serie_temporal
...
-- 5) rpc_receita_caixa_advisor_xp
...
BEGIN
  ...
  ELSE
    RAISE EXCEPTION 'p_papel deve ser BANKER ou FINDER';
  END IF;
END;
$function$;
